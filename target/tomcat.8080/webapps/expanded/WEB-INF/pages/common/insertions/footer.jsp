<footer id="footer" class="color-bg">
    ...
    <div class="link-list-row">
        <div class="container no-padding">
            <div class="col-xs-12 col-md-4 ">
                ...
                <div class="contact-info">
                    ...
                    <p>
                        ...
                        <spring:message code="common.lithuania"/>: +370 61 55-90-00 <br>
                        <spring:message code="common.belarus"/>: +375 (29) 255-88-88 <br>
                        <spring:message code="common.russiaMoscow"/>: +7 (903) 506-04-24 <br>
                        <spring:message code="common.russiaNovosibirsk"/>: +7 (903) 930-22-24 <br>
                        <spring:message code="common.ukraineKiev"/>: +380 (97) 781-68-44 <br>
                    </p>
            ...
            <div class="col-xs-12 col-md-8 no-margin footer-info">
